...
spec = describe "TinyRAM end to end" $ do
  ...
  -- cmpaeEqualTestCaseL --bugged reported
  cmpaeEqualTestCaseE
  cmpaeEqualTestCaseG
  --cmpaeGreaterTestCaseL --bugged reported
  cmpaeGreaterTestCaseE
  cmpaeGreaterTestCaseG
...
-- cmpaeGreaterTestCaseL :: Spec
-- cmpaeGreaterTestCaseL =
--   it "answers 0" $ do
--     let program =
--           construct
--             [ Mov (reg' 0) (imm 0),
